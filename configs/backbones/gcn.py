...
class GCN(BaseModule):
    ...
    def __init__(self,
                 ...
                 drop_path_rate=0.0,):
        super(GCN, self).__init__(init_cfg)
        ...
        self.gc2 = GraphConvolution(512, 5)
    ...
    def forward(self, x, **kwargs):
        ...
        for i, layer_name in enumerate(self.res_layers):
            ...
            if i in self.out_indices:
                outs.append(x)
        # 上面ResNet得到的x的维度是[batch_size, 512, 7, 8]
        # 为了GCN添加的
